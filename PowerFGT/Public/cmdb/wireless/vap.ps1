...
function Get-FGTWirelessVAP {
    ...
    <#
        ...
        .EXAMPLE
        Get-FGTWirelessVAP -schema

        Get schema of Wireless VAP
    ...
    Process {
        ...
        $response = Invoke-FGTRestMethod -uri 'api/v2/cmdb/wireless-controller/vap' -method 'GET' -connection $connection @invokeParams
        $response.results
    }
