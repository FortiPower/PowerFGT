...
function Add-FGTFirewallLocalInPolicy {
    ...
    <#
        ...
        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all

        Add a MyFGTPolicy with source port port1 and destination port2 and source and destination all

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -nat

        Add a MyFGTPolicy with NAT is enable

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -action "deny"

        Add a MyFGTPolicy with action is Deny

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -status:$false

        Add a MyFGTPolicy with status is disable

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -service "HTTP, HTTPS, SSH"

        Add a MyFGTPolicy with multiple service port

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -schedule workhour

        Add a MyFGTPolicy with schedule is workhour

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -comments "My FGT Policy"

        Add a MyFGTPolicy with comment "My FGT Policy"

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -logtraffic "all"

        Add a MyFGTPolicy with log traffic all

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -nat -ippool "MyIPPool"

        Add a MyFGTPolicy with IP Pool MyIPPool (with nat)

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -policyid 23

        Add a MyFGTPolicy with Policy ID equal 23

        .EXAMPLE
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -avprofile default -webfilterprofile default -dnsfilterprofile default -applicationlist default -ipssensor default

        Add a MyFGTPolicy with Security Profile (Antivirus, WebFilter, DNS Filter, Application, IPS)

        .EXAMPLE
        $data = @{ "logtraffic-start" = "enable" }
        Add-FGTFirewallLocalInPolicy -name MyFGTPolicy -intf port1 -srcaddr all -dstaddr all -data $data
    ...
    Process {
        ...
        if ( $PsBoundParameters.ContainsKey('name') ) {
            if ( Get-FGTFirewallLocalInPolicy -connection $connection @invokeParams -name $name ) {
        ...
        $policy | add-member -name "intf" -membertype NoteProperty -Value $intf
        ...
        if ( $PsBoundParameters.ContainsKey('name') ) {
            Get-FGTFirewallLocalInPolicy -name $name -connection $connection @invokeParams
        }
        else {
...
function Add-FGTFirewallLocalInPolicyMember {
    ...
    <#
        ...
        .EXAMPLE
        $MyFGTPolicy = Get-FGTFirewallLocalInPolicy -name MyFGTPolicy
        ...
        .EXAMPLE
        $MyFGTPolicy = Get-FGTFirewallLocalInPolicy -name MyFGTPolicy
        PS C:\>$MyFGTPolicy | Add-FGTFirewallLocalInPolicyMember
    ...
    Process {
        ...
        if ($PSCmdlet.ShouldProcess($policy.name, 'Add Firewall Policy Group Member')) {
            ...
            Get-FGTFirewallLocalInPolicy -connection $connection @invokeParams -name $policy.name
        }
    }
...
function Get-FGTFirewallLocalInPolicy {
    ...
    <#
        ...
        .EXAMPLE
        Get-FGTFirewallLocalInPolicy -name myPolicy
        ...
        .EXAMPLE
        Get-FGTFirewallLocalInPolicy -name FGT -filter_type contains
...
function Move-FGTFirewallLocalInPolicy {
    ...
    <#
        ...
        .EXAMPLE
        $MyFGTPolicy = Get-FGTFirewallLocalInPolicy -name MyFGTPolicy
        PS C:\>$MyFGTPolicy | Move-FGTFirewallLocalInPolicy -before -id (Get-FGTFirewallLocalInPolicy -name MyFGTPolicy23)

        Move Policy object $MyFGTPolicy before MyFGTPolicy23 (using Get-FGTFirewallLocalInPolicy)
...
function Set-FGTFirewallLocalInPolicy {
    ...
    <#
        ...
        Change MyFGTPolicy to intf port1 and srcaddr MyFGTAddress
        ...
        .EXAMPLE
        $MyFGTPolicy = Get-FGTFirewallLocalInPolicy -name MyFGTPolicy
        PS C:\>$MyFGTPolicy | Set-FGTFirewallLocalInPolicy -avprofile default -webfilterprofile default -dnsfilterprofile default -applicationlist default -ipssensor default

        Change MyFGTPolicy to set Security Profile to default (AV, WebFitler, DNS Filter, App Ctrl and IPS)

        .EXAMPLE
         $data = @{"logtraffic-start"  = "enable" }
        PS C:\>$MyFGTPolicy = Get-FGTFirewallLocalInPolicy -name MyFGTPolicy
        PS C:\>$MyFGTPolicy | Set-FGTFirewallLocalInPolicy -data $color
...
function Remove-FGTFirewallLocalInPolicyMember {
    ...
    <#
        ...
        .EXAMPLE
        $MyFGTPolicy = Get-FGTFirewallLocalInPolicy -name MyFGTPolicy
        PS C:\>$MyFGTPolicy | Remove-FGTFirewallLocalInPolicyMember
    ...
    Process {
        ...
        if ( $PsBoundParameters.ContainsKey('intf') ) {
            ...
            #check if there is always a member... (it is not really (dependy of release...) possible don't have member on Policy)
            if ( $members.count -eq 0 ) {
                Throw "You can't remove all members. Use Set-FGTFirewallLocalInPolicy to remove Source interface"
            }
        ...
        if ($PSCmdlet.ShouldProcess($policy.name, 'Remove Firewall Policy Group Member')) {
            ...
            Get-FGTFirewallLocalInPolicy -connection $connection @invokeParams -name $addrgrp.name
        }
    }
