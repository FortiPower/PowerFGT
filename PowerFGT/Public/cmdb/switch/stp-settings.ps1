...
function Get-FGTSwitchSTPSettings {
    ...
    Process {
        ...
        $response = Invoke-FGTRestMethod -uri 'api/v2/cmdb/switch-controller/stp-settings' -method 'GET' -connection $connection @invokeParams
        $response.results
    }
