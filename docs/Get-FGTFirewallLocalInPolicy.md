...
### default (Default)
```
Get-FGTFirewallLocalInPolicy [-filter_attribute <String>] [-filter_type <String>] [-filter_value <PSObject>]
...
### uuid
```
Get-FGTFirewallLocalInPolicy [-uuid <String>] [-filter_attribute <String>] [-filter_type <String>]
...
### policyid
```
Get-FGTFirewallLocalInPolicy [-policyid <String[]>] [-filter_attribute <String>] [-filter_type <String>]
 [-filter_value <PSObject>] [-meta] [-skip] [-vdom <String[]>] [-connection <PSObject>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
