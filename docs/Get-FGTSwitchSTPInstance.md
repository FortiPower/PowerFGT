...
### default (Default)
```
Get-FGTSwitchSTPInstance [-filter_attribute <String>] [-filter_type <String>] [-filter_value <PSObject>]
...
### id
```
Get-FGTSwitchSTPInstance [[-switchid] <String>] [-filter_attribute <String>] [-filter_type <String>]
