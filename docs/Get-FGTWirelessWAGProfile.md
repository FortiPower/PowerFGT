...
### default (Default)
```
Get-FGTWirelessWAGProfile [-filter_attribute <String>] [-filter_type <String>] [-filter_value <PSObject>]
...
### name
```
Get-FGTWirelessWAGProfile [[-name] <String>] [-filter_attribute <String>] [-filter_type <String>]
...
### EXAMPLE 5
```
Get-FGTWirelessWAGProfile -schema
```

Get schema of Wireless WAG Profile
